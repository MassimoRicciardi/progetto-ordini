sap.ui.define([
    ...
    function (Controller, JSONModel, Fragment, Button, Dialog, Link, ButtonType ) {
        ...
        return Controller.extend("progetto4.progetto4.controller.View5", {
            onInit: function () {
                var datio = [{
                    nordine: "#123456788",
                    quantità: "1",
            ...
            onDettagli: function () {
                ...
                if (!this.byId("dettagliOrdine")) {
                    // load asynchronous XML fragment
                    Fragment.load({
                        id: oView.getId(),
                        name: "progetto4.progetto4.view.DialogDettagli",
                        controller: this
