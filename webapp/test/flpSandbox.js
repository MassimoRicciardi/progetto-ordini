		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#progetto4progetto4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"progetto4progetto4-display": {
								"semanticObject": "progetto4progetto4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=progetto4.progetto4",
									"url": sap.ui.require.toUrl("progetto4/progetto4")
								}
							}
						}
					}
